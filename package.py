...
class Package(j.baseclasses.threebot_package):
    ...
    kosmos -p "j.tools.threebot_packages.get('faircoffe_trade',giturl='https://github.com/faircoffee-trade/www_faircoffe_trade.git',branch='master')"
    kosmos -p "j.servers.threebot.default.start(web=True, ssl=False)"
    """
    def _init(self, **kwargs):
        self.branch = kwargs["package"].branch or "master"
        self.cultivo_earth = "https://github.com/faircoffee-trade/www_faircoffe_trade.git"
